import type { SubTask } from "@/types/app";
...
import { useAddSubTaskMutation, useUpdateSubTaskMutation } from "@/hooks/use-activity";
...
export const SubTasksDetails = ({
  ...
  const handleToggleTask = (subTaskId: string, checked: boolean) => {
    updateSubTask(
      { activityId, subTaskId, completed: checked },
      {
        onSuccess: () => {

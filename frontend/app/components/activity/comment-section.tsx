import type { Comment, User } from "@/types/app";
...
import {
  ...
  useGetCommentsActivityByIdQuery,
...
export const CommentSection = ({
  ...
  const { data: comments, isLoading } = useGetCommentsActivityByIdQuery(
    activityId
  ) as {
    data: Comment[];
    isLoading: boolean;

...
import type { Activity, ProjectMemberRole, User } from "@/types/app";
import { useUpdateActivityAssigneesMutation } from "@/hooks/use-activity";

export const ActivityAssigneesSelector = ({
  activity,
  assignees,
  projectMembers,
}: {
  ...
  const { mutate, isPending } = useUpdateActivityAssigneesMutation();
